  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+94) 26-345-6789</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Bucharest Recruitment Agency<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                          <a href="#" data-toggle="dropdown" class="dropdown-toggle">Job Category<b class="caret"></b></a>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <strong>Bucharest</strong><br>
           117/A, Ward No-01, Nilaveli<br>
           Pin-31010 Sri lanka.</address>
          <p>
            <i class="icon-phone"></i> (+94) 26-345-6789 <br>
            <i class="icon-envelope-alt"></i> bucharest@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; 2019ICTS102 2024 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
