...
function doInsert($jobid = 0, $fileid = 0) {
    if (isset($_POST['submit'])) {  
        ...
        if ($age < 20) {
            ...
            message("Your application has been submitted. Please wait for the company confirmation regarding your qualification for this job.", "success");
...
function doRegister() {
    ...
    if (isset($_POST['btnRegister'])) { 
        ...
        if ($age < 20) {
            ...
            message("You have successfully registered on the site. You can login now!", "success");
